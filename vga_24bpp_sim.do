...
-- control register, bl-pos, cl-pos, vs-pos, hs-pos, x, 24bpp, vbl-8cycle, bs-en, bsi-en, hi-en, vi-en, v-en
...
force -freeze /vga/sdat_i 16#0000059f 188ns, 16#ZZZZZZZZ 193ns
...
force -freeze /vga/sel_i 1111 928ns, 0000 933ns
force -freeze /vga/stb_i 1 928ns, 0 933ns
force -freeze /vga/we_i 1 928ns, 0 933ns
force -freeze /vga/adr_i 001 928ns, ZZZ 933ns
force -freeze /vga/sdat_i 16#00000040 928ns, 16#ZZZZZZZZ 933ns

-- INTA_O is asserted (horizontal sync), clear it
